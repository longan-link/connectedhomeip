...
//#if CONFIG_ENABLE_Lightning_BLE_CONTROLLER && CONFIG_BT_NIMBLE_ENABLED
...
//TODO: fix below header file
//#include <platform/lightning/ChipDeviceScanner.h>
...
//#endif
/**
 * Concrete implementation of the BLEManager singleton object for the LN platform.
 */
...
//#endif
    ...
    enum class Flags : uint16_t
    {
        ...
        kLNBLELayerInitialized   = 0x0002, /**< The LN BLE layer has been initialized. */
        kAppRegistered            = 0x0004, /**< The CHIPoBLE application has been registered with the LN BLE layer. */
        kAttrsRegistered          = 0x0008, /**< The CHIPoBLE GATT attributes have been registered with the LN BLE layer. */
        kGATTServiceStarted       = 0x0010, /**< The CHIPoBLE GATT service has been started. */
        kAdvertisingConfigured    = 0x0020, /**< CHIPoBLE advertising has been configured in the LN BLE layer. */
        kAdvertising              = 0x0040, /**< The system is currently CHIPoBLE advertising. */
        kControlOpInProgress      = 0x0080, /**< An async control operation has been issued to the LN BLE layer. */
        ...
        kAdvertisingRefreshNeeded = 0x0800, /**< The advertising configuration/state in LN BLE layer needs to be updated. */
    };
...
//#endif
    ...
    CHIP_ERROR InitLightningBleLayer(void);
 ...
 * that are specific to the LN platform.
 */
