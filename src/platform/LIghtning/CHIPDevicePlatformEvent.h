 ...
 *          Device Layer on Lightning platforms.
 */
...
{
    kLightningPlatformEvent = kRange_InternalPlatformSpecific,
    kLightningBLEConnected,
    kPlatformLightningBLECentralConnectFailed
    kLightningBLEDisconnected,
    kCHIPoBLECCCWriteEvent,
    kCHIPoBLERXCharWriteEvent,
    kCHIPoBLETXCharWriteEvent,
    kLightningkWiFiStationConnectedEvent,
    kLightningkWiFiStationDisconnectedEvent,
    kLightningkWiFiScanCompletedEvent,
};
