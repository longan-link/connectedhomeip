 ...
 *          for lightningsemi platforms using the LN882H SDK.
 */
...
#include <platform/Lightning/DiagnosticDataProviderImpl.h>
...
{
    lightning_fill_random(output, len);
    *olen = len;
    return 0;
}
...
void PlatformManagerImpl::HandleLightningSystemEvent(void * arg, wifi_mgr_event_t eventBase, int32_t eventId, void * eventData)
{
    ...
    //         //memcpy(&event.Platform.ESPSystemEvent.Data.IpApStaIpAssigned, eventData,sizeof(event.Platform.ESPSystemEvent.Data.IpApStaIpAssigned));
    //         break;
    //     default:
    //         break;
    //     }
