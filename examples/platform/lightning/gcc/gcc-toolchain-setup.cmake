...
if (EXISTS "${PROJ_DIR}/../../../.environment/cipd/packages/arm")
    message(STATUS "cipd Initialized successfully")
else()
    message(FATAL_ERROR  "cipd must be Initialized, please run\n source/scripts/bootstarp.sh\n to inintlize workspace!!!")
endif()

set(CROSS_TOOLCHAIN_ROOT ${PROJ_DIR}/../../../.environment/cipd/packages/arm)
set(COMPILER_HOME  ${CROSS_TOOLCHAIN_ROOT}  CACHE  PATH  "cross-compiler home"  FORCE)
set(TOOL_SUFFIX     "")
...
message(STATUS "COMPILER_HOME ${COMPILER_HOME}")
