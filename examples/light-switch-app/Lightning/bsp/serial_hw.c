...
{
    if (hal_uart_it_en_status_get(UART0_BASE, USART_IT_RXNE) && hal_uart_flag_get(UART0_BASE, USART_FLAG_RXNE))
    {
        uart0_recv_data_isr();
    }

    if (hal_uart_it_en_status_get(UART0_BASE, USART_IT_TXE) && hal_uart_flag_get(UART0_BASE, USART_FLAG_TXE))
    {
        uart0_send_data_isr();
    }
}
...
{
    if (hal_uart_it_en_status_get(UART1_BASE, USART_IT_RXNE) && hal_uart_flag_get(UART1_BASE, USART_FLAG_RXNE))
    {
        uart1_recv_data_isr();
    }

    if (hal_uart_it_en_status_get(UART1_BASE, USART_IT_TXE) && hal_uart_flag_get(UART1_BASE, USART_FLAG_TXE))
    {
        uart1_send_data_isr();
    }
}
...
{
    if (hal_uart_it_en_status_get(UART2_BASE, USART_IT_RXNE) && hal_uart_flag_get(UART2_BASE, USART_FLAG_RXNE))
    {
        uart2_recv_data_isr();
    }

    if (hal_uart_it_en_status_get(UART2_BASE, USART_IT_TXE) && hal_uart_flag_get(UART2_BASE, USART_FLAG_TXE))
    {
        uart2_send_data_isr();
    }
}
